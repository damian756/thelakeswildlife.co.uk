...
export default async function InsectPage({ params }: Props) {
  ...
  const pageUrl = `${BASE}/insects/${slug}`;
    ...
    "@graph": [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Insects", item: `${BASE}/insects` },
  ...
  return (
    <>
      ...
      <SpeciesDetail category="insects" species={species} related={related} slug={slug} />
    </>
  );
}
